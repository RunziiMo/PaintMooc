...
public class FileUtils {
    ...
    public static String getRealPathFromURI(Uri contentUri) {
        if (contentUri == null)
            return null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT && DocumentsContract.isDocumentUri(AppManager.getAppContext(), contentUri)) {
            if (isExternalStorageDocument(contentUri)) {
                ...
                return getDataColumn(AppManager.getAppContext(), uri, null, null);
                ...
                return getDataColumn(AppManager.getAppContext(), uri, selection, selectionArgs);
            }
            ...
            return getDataColumn(AppManager.getAppContext(), contentUri, null, null);
        }
        // File
